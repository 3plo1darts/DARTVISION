...
interface CameraFeedProps {
  ...
  intervalMs?: number;
  detectedDarts?: Dart[];
  lowRes?: boolean; // Nuova prop per forzare cattura veloce
}
...
export const CameraFeed: React.FC<CameraFeedProps> = ({ 
  ...
  }, [isActive, hasPermission, intervalMs, onFrameCapture, lowRes]);
      ...
      {detectedDarts.map((dart, idx) => (
        ...
        >
           <div className="flex flex-col items-center -translate-x-1/2 -translate-y-1/2">
              ...
              <div className="mt-3 bg-black/90 text-white text-[10px] font-black px-2.5 py-1 rounded-md shadow-2xl border border-red-600/50 whitespace-nowrap backdrop-blur-sm">
      ...
      {!hasPermission && (
        <div className="absolute inset-0 flex items-center justify-center bg-black z-50">
          <div className="flex flex-col items-center gap-4">
             ...
             <p className="text-red-500 font-black text-xs uppercase tracking-widest animate-pulse">Neural Link...</p>
          </div>
        </div>
      )}
